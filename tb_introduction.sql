...
CREATE OR REPLCAE SCHEMA frostbyte_tasty_bytes.raw_pos;

-- create raw_customer schema
CREATE OR REPLCAE SCHEMA frostbyte_tasty_bytes.raw_customer;

-- create harmonized schema
CREATE OR REPLCAE SCHEMA frostbyte_tasty_bytes.harmonized;
